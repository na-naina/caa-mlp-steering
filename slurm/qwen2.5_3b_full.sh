#!/bin/bash
#SBATCH --job-name=qwen2.5_3b
#SBATCH --partition=gpu
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=10
#SBATCH --mem=80G
#SBATCH --gres=gpu:lovelace_l40:2
#SBATCH --output=logs/qwen2.5_3b_%j.out
#SBATCH --error=logs/qwen2.5_3b_%j.err
...
python -m src.jobs.run_experiment --config configs/qwen2.5_3b_full.yaml --run-id qwen2.5_3b_$(date +%Y%m%d_%H%M%S)
