#!/bin/bash
#SBATCH --job-name=gemma3_4b_full
#SBATCH --partition=gpu
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=90G
#SBATCH --gres=gpu:lovelace_l40:2
#SBATCH --output=logs/gemma3_4b_full_%j.out
#SBATCH --error=logs/gemma3_4b_full_%j.err
...
python -m src.jobs.run_experiment --base-config configs/base.yaml --config configs/gemma3_4b_full.yaml --run-id gemma3_4b_full_$(date +%Y%m%d_%H%M%S)
