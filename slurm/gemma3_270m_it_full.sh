#!/bin/bash
#SBATCH --job-name=gemma3_270m_it
#SBATCH --partition=gpu
#SBATCH --time=08:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --gres=gpu:lovelace_l40:2
#SBATCH --output=logs/gemma3_270m_it_%j.out
#SBATCH --error=logs/gemma3_270m_it_%j.err
...
python -m src.jobs.run_experiment --base-config configs/base.yaml --config configs/gemma3_270m_it_full.yaml --run-id gemma3_270m_it_$(date +%Y%m%d_%H%M%S)
