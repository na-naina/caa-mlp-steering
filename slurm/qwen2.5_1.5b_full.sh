#!/bin/bash
#SBATCH --job-name=qwen2.5_1.5b
#SBATCH --partition=gpu
#SBATCH --time=10:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --gres=gpu:lovelace_l40:2
#SBATCH --output=logs/qwen2.5_1.5b_%j.out
#SBATCH --error=logs/qwen2.5_1.5b_%j.err
...
python -m src.jobs.run_experiment --config configs/qwen2.5_1.5b_full.yaml --run-id qwen2.5_1.5b_$(date +%Y%m%d_%H%M%S)
