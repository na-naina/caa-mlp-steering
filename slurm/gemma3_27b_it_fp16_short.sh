#!/bin/bash
#SBATCH --job-name=gemma3_27b_it_fp16
#SBATCH --partition=gpu
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=16
#SBATCH --mem=180G
#SBATCH --gres=gpu:lovelace_l40:3
#SBATCH --output=logs/gemma3_27b_it_fp16_%j.out
#SBATCH --error=logs/gemma3_27b_it_fp16_%j.err
...
python -m src.jobs.run_experiment --config configs/gemma3_27b_it_fp16_short.yaml --run-id gemma3_27b_it_fp16_short_$(date +%Y%m%d_%H%M%S)
