...
#SBATCH --output=logs/qwen2.5_7b_%j.out
#SBATCH --error=logs/qwen2.5_7b_%j.err
...
python -m src.jobs.run_experiment --config configs/qwen2.5_7b_full.yaml --run-id qwen2.5_7b_$(date +%Y%m%d_%H%M%S)
