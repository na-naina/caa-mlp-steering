#!/bin/bash
#SBATCH --job-name=gemma3_12b_it
#SBATCH --partition=gpu
#SBATCH --time=05:00:00
#SBATCH --cpus-per-task=12
#SBATCH --mem=128G
#SBATCH --gres=gpu:lovelace_l40:2
#SBATCH --output=logs/gemma3_12b_it_%j.out
#SBATCH --error=logs/gemma3_12b_it_%j.err
...
python -m src.jobs.run_experiment --base-config configs/base.yaml --config configs/gemma3_12b_it_full.yaml --run-id gemma3_12b_it_$(date +%Y%m%d_%H%M%S)
