#!/bin/bash
#SBATCH --job-name=gemma3_27b_it
#SBATCH --partition=gpu
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=16
#SBATCH --mem=180G
#SBATCH --gres=gpu:lovelace_l40:3
#SBATCH --output=logs/gemma3_27b_it_%j.out
#SBATCH --error=logs/gemma3_27b_it_%j.err
...
python -m src.jobs.run_experiment --base-config configs/base.yaml --config configs/gemma3_27b_it_full.yaml --run-id gemma3_27b_it_$(date +%Y%m%d_%H%M%S)
